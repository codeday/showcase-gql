# Migration `20230308210621-add-peer-judging`

This migration has been generated by Lola at 3/8/2023, 3:06:21 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
CREATE TABLE "PeerJudgement" (
    "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "PeerJudgement.username_eventId_projectId_unique" ON "PeerJudgement"("username", "eventId", "projectId")

ALTER TABLE "PeerJudgement" ADD FOREIGN KEY("projectId")REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE "Kudos" ADD FOREIGN KEY("projectId")REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE
```
...
migration 20221123064810-add-media-featured..20230308210621-add-peer-judging
--- datamodel.dml
+++ datamodel.dml
@@ -1,234 +1,260 @@
-datasource db {
